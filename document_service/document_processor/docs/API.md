...
document service 通过 `DocumentResourceService.PrepareResources` 接收多个 filename/bytes，完成解析、文档树和 embedding 后返回 resource_path。共享协议和错误码见 [agent API](../../../agent/docs/API.md)。
