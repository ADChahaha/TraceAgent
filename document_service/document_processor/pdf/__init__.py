"""`document_service.document_processor.pdf` 的包级公共导出。
...
from document_service.document_processor.pdf.converter import convert_pdf_bytes_to_content_list
from document_service.document_processor.pdf.html import build_html_from_content_list
