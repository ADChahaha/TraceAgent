...
from document_service.document_processor.pdf.converter import (
...
def test_resolve_mineru_executable_errors_when_missing(monkeypatch):
    ...
    monkeypatch.setattr("document_service.document_processor.pdf.converter.shutil.which", lambda name: None)
