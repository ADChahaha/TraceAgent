...
def test_process_validates_input_then_calls_pdf_pipeline(monkeypatch):
    from document_service.document_processor import processor as processor_module
...
def test_process_rejects_objects_without_file_like_read_method():
    from document_service.document_processor import processor as processor_module
    from document_service.document_processor.processor import InvalidFileObjectError
...
def test_process_rejects_unsupported_explicit_type():
    from document_service.document_processor import processor as processor_module
    from document_service.document_processor.processor import UnsupportedFileTypeError
