"""service.file_extraction_agent 的 field resolution 节点。"""
...
from service.file_extraction_agent.impl.prompts import build_field_resolution_messages
...
from service.file_extraction_agent.impl.validation import apply_field_constraints, apply_validation_rules
from service.file_extraction_agent.schemas import FieldDefinition, FieldEvidenceRef
