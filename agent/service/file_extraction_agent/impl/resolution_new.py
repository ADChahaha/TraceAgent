...
def build_resolution_messages(state: Any) -> list[Any]:
    system = SystemMessage(
        content=(
            ...
            "Try to collect complete final evidence for the named fields within the current plan before setting those fields. "
            ...
            "When switching to a new plan, reread or preview the needed evidence under the new plan instead of relying only on older context. "
