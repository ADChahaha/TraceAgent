...
def build_resolution_messages(state: Any) -> list[Any]:
    system = SystemMessage(
        content=(
            ...
            "After the first useful tree result, share a short user-facing reading map before heavy reading begins. "
            "Use Markdown bullets for this reading map. "
            "It is not a complete directory dump; only include structure relevant to task_spec fields and explain how the structure guides your next reads. "
            "The reading map explains your current plan; it does not lock the later reading order. "
            "Keep the reading map in the task_spec language. "
