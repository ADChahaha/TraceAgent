...
def build_resolution_messages(state: Any) -> list[Any]:
    system_content = (
        ...
        "final answer, cover document facts with the final Sources section instead "
        "of inline links.\n\n"
        "Format:\n"
        ...
        "reads directly.\n"
        "For the final answer, use NotebookLM-style end citations. Do not put "
        "evidence links inline in the final answer body. Append a final Sources "
        "section and list each source as [1] [short label](evidence://...), [2] "
        "[short label](evidence://...), and so on.\n\n"

        "## Final Answer\n"
        "- Answer in the same language as the user's question.\n"
        "- Conclusion first, then supporting details without inline evidence links.\n"
        "- Append a final Sources section with Markdown evidence links for the "
        "document facts used in the answer.\n"
