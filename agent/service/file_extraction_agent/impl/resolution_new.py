...
def build_resolution_messages(state: Any) -> list[Any]:
    system = SystemMessage(
        content=(
            ...
            "Write assistant content in the same language as task_spec; if task_spec mixes languages, "
            "use the dominant language of its field descriptions and instructions, and keep quoted source text in the original source language. "
            ...
            "In assistant content, continuous block spans may use evidence://range/<start>/<end>, where start and end are readable block path_ids in the same section. "
