...
def build_qa_messages(history: list[DocumentQaMessage]) -> list[AnyMessage]:
    system_content = (
        ...
        "每个文档块是对象存储中的 .md 对象，目录 key 按章节组织。工具参数和引用链接原样使用返回的 documents/... key，不使用本机路径或 s3:// URL。 "
        ...
        "  [ls, grep]\n\n"
        "  'Contract Section 5: [monthly $8,500, due 15th](documents/0001-contract/0001-section/0001-block.md). "
        ...
        "supports.\n\n"
        "Format:\n"
        "- Block link: [label](documents/0001-contract/0001-section/0001-block.md)\n\n"
        ...
        "[1](documents/0001-contract/0001-section/0001-block.md). Do not use "
        "descriptive final citation labels like [payment deadline](documents/...). "
        ...
        "- Use numeric citation labels only: [1](documents/...), [2](documents/...).\n"
