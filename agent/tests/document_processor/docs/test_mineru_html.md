...
```text
MinerU pages
  -> 过滤 image/page_number/page_header 这类不可用于推理的噪声
...
- `test_build_display_html_wraps_extraction_html_with_replay_style`：确认展示 HTML 包含抽取 HTML 和 evidence highlight 样式。
