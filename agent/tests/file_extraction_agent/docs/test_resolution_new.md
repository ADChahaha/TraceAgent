...
- `test_resolution_messages_embed_compact_document_outline`：确认 resolution prompt 包含 compact outline、字段写入规则、中文 replay reason 规则、按最早未完成 broad plan 顺序推进的约束、章节读取策略和 SQL 列名双引号要求。
