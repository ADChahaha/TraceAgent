...
from document_processor.impl.docling_blocks import build_blocks_from_docling_document
from document_processor.schemas import BoundingBox, ContentBlock

_AGENT_ROOT = Path(__file__).resolve().parents[3]
_DEFAULT_DOCLING_ARTIFACTS_PATH = (
    _AGENT_ROOT / "document_processor" / "impl" / "pdf" / "artifacts" / "docling-models"
)
